...
import { PlaylistItemProps } from "@/type/song-recommendation";
            ...
            <CardHeader className="min-w-0 flex-1 gap-1 p-0">
                <CardTitle className="truncate font-semibold leading-none">
                    <Typography
                        ...
                        className={cn(
                            "truncate",
                            active ? "text-[#e8e8ea]" : "text-foreground"
                        )}
                    >
                        {title}
                    </Typography>
                ...
                {!matchedEffect && subtitle && subtitle !== title && (
